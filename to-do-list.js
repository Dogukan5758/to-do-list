...
//bu inputun koşula uygun olup olmadığını kontrol edebilmemiz için if bloğu oluşturalım. Hiç bir şey girilmezse; 
    if(inputValue == ''){
        toastTrigger.addEventListener('click', () => {
          ...
          //her iki durumda da gizli olan error toast alertleri gösteriyoruz. Boostrapin sitesinde bu koda ulaşabilirsiniz. Websitesinde hazır olarak verilmiş. 
    }
    //Kullanıcı space karakter girdiyse bunun için ayrı bir fonksiyonumuz var
        ...
        resetInput(); //sıfırladık
         ...
         //success toast gösterebiliriz artık :)
         localStorage.setItem('inputValue', JSON.stringify(inputValue)); //girilen son elemanın local storage da tutulması
         var save = localStorage.getItem("inputValue");
